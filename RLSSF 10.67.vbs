...
'	Intelligent xpos, ypos functions to find the location of an object, auto failover if x,y are not available to ball position
'
'	To use:
'
...
'	Set Audio_Table = table1				' 10.6 explicitly set the table - change 'table1' per table
'	On Error Goto 0
'
'
'	Functions:
...
'	R.Lincoln	October 2201	Support 10.6 and 10.7 seamlessly
'
'**********************************************************************************************************
...
'	If I can't find the ball position use table centre
'
Function xpos(tableobj)
	on error resume next
	xpos = Audio_Table.width /2	' Middle
	xpos = activeball.x		' Ball position
	xpos = tableobj.x		' Object position
End Function

Function ypos(tableobj)
	on error resume next
	ypos = Audio_Table.height /2	' Middle
	ypos = activeball.y		' Ball position
	ypos = tableobj.y		' Object position
End Function
